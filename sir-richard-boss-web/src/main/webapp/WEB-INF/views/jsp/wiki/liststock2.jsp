...
<c:if test="${not empty msg}">		
		...
		<br/>
          ...
          <div class="table-responsive-sm">
            <table id="stock-products" class="table table-striped- table-sm table-hover-" style="font-size: 14px; width: 100%">
            <thead>
				<tr>
					...
					<th scope="col"><fmt:message key="wiki.stock.table.headers.supplier.quantity" /></th>
			...
			<tbody>
				...
				<tr class="table-">				
						...
						<td class="text-right">${supplierStockProduct.product.supplierQuantity}</td>												
	        ...
	        <div>
	         ...
	         <p class="text-right"><fmt:message key="wiki.stock.table.footers.amount.totalSupplier" />&nbsp;<strong><fmt:formatNumber type = "currency" value = "${stockTotal.totalSupplierAmount}" /></strong></p>
	         <p class="text-right"><fmt:message key="wiki.stock.table.footers.amount.totalBill" />&nbsp;<strong><fmt:formatNumber type = "currency" value = "${stockTotal.totalBillAmount}" /></strong></p>
		    </div>
...
$('#stock666').DataTable({	
    ...
    "ajax": {
        "url": "${urlHome}ajax/wiki/stock-products/post2/suppliers/list",
        "type": "POST",
        "dataType": "json",
...
*/
		...
		$('#select-stock-category').prop('hidden', true);
