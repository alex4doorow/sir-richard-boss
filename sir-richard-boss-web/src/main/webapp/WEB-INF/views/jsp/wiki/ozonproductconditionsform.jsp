...
<title><fmt:message key="app.title" /> | <fmt:message key="wiki.ozon.products.conditions.form.filter.title" /></title>
...
<div
	class="d-flex justify-content-start flex-wrap flex-md-nowrap align-items-start">
			...
			<h1 class="h2">
				<fmt:message key="wiki.ozon.products.conditions.form.filter.header" />
			</h1>
...
<br/>
			<spring:url value="/wiki/products/ozon/conditions/filter/exec" var="productConditionsExecActionUrl" />
			<form:form id="wiki-ozon-products-conditions-form" class="needs-validation" method="post" modelAttribute="productConditions" action="${productConditionsExecActionUrl}">
								
				<h4 class="mb-4"><fmt:message key="wiki.ozon.products.form.headers.products" /></h4>
								
				<div class="form-row">
					<div class="form-group col-3">	
						<label for="select-yandex-seller-exist-types"><fmt:message key="wiki.ozon.products.conditions.form.fields.ozonSellerExist" /></label>
						<form:select path="ozonSellerExist" id="select-ozon-seller-exist-types" class="form-control form-control-sm">
							<form:options items="${ozonSellerExistTypes}" itemValue="id" itemLabel="value" />
						</form:select>					
					</div>				
				</div>
				<div class="form-row">
					<div class="form-group col-3">	
						<label for="select-supplier-stock-types"><fmt:message key="wiki.ozon.products.conditions.form.fields.supplierStockExist" /></label>
				...
				<hr class="mb-4">
				<h6 class="mb-4"><fmt:message key="wiki.ozon.products.form.headers.suppliers" /></h6>
				<div class="form-row">
					<div class="col-sm-5">										
...
<script>
	...
	$('#btn-excute-filter').click(function() {			
		$('#wiki-ozon-products-conditions-form').submit();
	});
