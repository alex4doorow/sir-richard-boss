...
<title><fmt:message key="app.title" /> | <fmt:message key="reports.productSales.form.title" /></title>
...
<div
	class="d-flex justify-content-start flex-wrap flex-md-nowrap align-items-start">
			...
			<h1 class="h2">
				<fmt:message key="reports.productSales.form.header" />
			</h1>
</div>
<div
...
<br />
			<spring:url value="${urlReport}product-sales/filter/exec" var="reportProductSalesFilterExecActionUrl" />
			<form:form id="report-product-sales-form" class="needs-validation" method="post" modelAttribute="reportForm" action="${reportProductSalesFilterExecActionUrl}">
				...
				<h4 class="mb-4"><fmt:message key="reports.productSales.form.headers.period" /></h4>
				
				<div class="form-row">				
					<spring:message code="reports.productSales.form.fields.placeholder.period.start" var="reportProductSalesFormFieldsPlaceholderPeriodStart"/> 
					<spring:bind path="periodStart">
					<div class="form-group col-2">					
						<label for="input-period-start"><fmt:message key="reports.productSales.form.fields.period.start" /></label> 
						<div class="input-group">
							...
							<div class="invalid-feedback"><fmt:message key="reports.productSales.form.fields.invalidFeedback.period.start" /></div>
						</div>	
					</div>
					</spring:bind>
					
					<spring:message code="reports.productSales.form.fields.placeholder.period.end" var="reportProductSalesFormFieldsPlaceholderPeriodEnd"/> 
					<spring:bind path="periodEnd">
					<div class="form-group col-2">					
						<label for="input-period-end"><fmt:message key="reports.productSales.form.fields.period.end" /></label> 
						<div class="input-group">
							...
							<div class="invalid-feedback"><fmt:message key="reports.productSales.form.fields.invalidFeedback.period.end" /></div>
						</div>	
					</div>
					</spring:bind>
				</div>
				<div class="form-row">				
					<div class="form-group col-md-2">
						<label for="input-advert-budget"><fmt:message key="reports.productSales.form.fields.advertBudget" /></label>
						<form:input path="advertBudget" type="text" class="form-control form-control-sm form-control-input-text input-calc-amounts" id="input-advert-budget" />
					</div>							
				</div>																
				<hr class="mb-4">	
