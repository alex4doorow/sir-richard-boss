...
public class CloneableTest {
	...
	public void testOne() throws CloneNotSupportedException {
		...
		addressOne.setId(1);
		addressOne.setAddress("г.Псков, ул.Школьная , д.11, кв. 43");
		...
		addressTwo.setAddress("Якутск, ул. Чиряева, 4");
		...
		two.setId(2);
		two.setNo(6002);
		two.getCustomer().getMainAddress().setAddress("г.Москва, ул.Байкальская 18 к 1 кв 82");
