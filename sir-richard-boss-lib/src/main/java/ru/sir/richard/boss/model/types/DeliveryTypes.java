...
public enum DeliveryTypes {
	...
	CDEK_PVZ_TYPICAL(101, "ТК СДЭК", "СДЭК, ПВЗ"),
	CDEK_PVZ_ECONOMY(102, "ТК СДЭК", "СДЭК, ЭКОНОМ ПВЗ"),
	CDEK_COURIER(103, "ТК СДЭК", "СДЭК, курьер"),
	CDEK_COURIER_ECONOMY(104, "ТК СДЭК", "СДЭК, ЭКОНОМ курьер"),
	...
	DeliveryTypes(int id, String category, String annotation, String code) {
		this.id = id;
		this.category = category;
		this.annotation = annotation;
		this.code = code;
	...
	public static DeliveryTypes getValueById(int value) {
		if (value == 101) {
