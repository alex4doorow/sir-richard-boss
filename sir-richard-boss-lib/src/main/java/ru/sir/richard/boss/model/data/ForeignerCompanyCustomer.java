...
public class ForeignerCompanyCustomer extends AnyCustomer {
	...
	public ForeignerCompanyCustomer(Countries country) {
		...
		contacts.add(new Contact(country));
	}
	...
	public ForeignerCompanyCustomer clone() throws CloneNotSupportedException  {
		...
		clone.inn = this.inn == null ? null : new String(this.inn);
		clone.shortName = this.shortName == null ? null : new String(this.shortName);
		clone.longName = this.longName == null ? null : new String(this.longName);		
