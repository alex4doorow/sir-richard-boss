package ru.sir.richard.boss.report.data;
...
public class DataBeanList {
	   public ArrayList<DataBean> getDataBeanList() {
	      ...
	      dataBeanList.add(produce("Вася", "Мордория",
	         Arrays.asList(subBean1)));
	      dataBeanList.add(produce("Петя Лавочкин", "USA",
	         Arrays.asList(subBean2)));
	      dataBeanList.add(produce("V.Anand", "Мордория",
	         Arrays.asList(subBean1)));
