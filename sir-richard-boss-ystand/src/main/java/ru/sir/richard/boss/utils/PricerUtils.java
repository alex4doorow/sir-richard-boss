...
public class PricerUtils {
	...
	private static class SititekPriceTranslatorCreator {
		...
		private Map<String, Product> sititekPriceload() {
			...
			//translatorPut(608, "Зарядное уст-во на солнечных батареях \"Sun-Power P3\"");
			//translatorPut(711, "Зарядное уст-во на солнечных батареях \"Sun-Power P4\" (P4+F80)");
			//translatorPut(712, "Зарядное уст-во на солнечных батареях \"Sun-Power P5\"");
			
			//			
			//translatorPut(280, "Индикатор поля \"BugHunter CL-01\"");
			...
			*/
			...
			//
			//translatorPut(152, "Микроскоп цифровой SITITEK \"Микрон Space\"");
			...
			//translatorPut(94, "Набор для экологического контроля СОЭКС (Экотестер+Импульс)");
			//translatorPut(92, "Экотестер2 СОЭКС (дозиметр+нитратомер)");
			translatorPut(445, "Нитратомер + солемер \"EcoLifePro2\"");
			//translatorPut(93, "Нитратомер2 \"СОЭКС\"");
			//translatorPut(714, "Эковизор СОЭКС F2");
			//translatorPut(637, "Эковизор СОЭКС F4");
			...
			translatorPut(547, "Ножеточка электрическая Хозяйка 50М");
			...
			//translatorPut(-1, "Отпугиватель грызунов ультразвуковой \"SITITEK 2D\"");
			...
			//translatorPut(858, "Уничтожитель грызунов \"SITITEK Antirats\"");
			...
			//translatorPut(145, "Отпугиватель собак стационарный \"Weitech WK0051\"");
			...
			translatorPut(725, "Аксессуар для отпугивателей собак Weitech-0052/0054/0055 - адаптер питания WKT052");			
			...
			//translatorPut(581, "Подавитель микрофонов любых устройств звукозаписи \"Канонир-12К\" (комбинированный)");
			//translatorPut(582, "Подавитель микрофонов любых устройств звукозаписи \"Канонир-7К\" (комбинированный)");
			...
			//translatorPut(433, "Уничтожитель комаров \"SITITEK Садовый-М\"");
			//translatorPut(891, "Уничтожитель комаров \"SITITEK Садовый-К\"");
			...
			//
			/*
			translatorPut(575, "Шланг для полива \"Magic hose  7,5 м\" (Xhose)");
			translatorPut(-1, "Шланг для полива \"Magic hose 15 м\" (Xhose)",  true, 575);
			translatorPut(-1, "Шланг для полива \"Magic hose 22,5 м\" (Xhose)",  true, 575);
			translatorPut(-1, "Шланг для полива \"Magic hose 30 м\" (Xhose)",  true, 575);
			*/
			//
			/*
			translatorPut(603, "Электроошейник \"PetLiner 1000\"");
			translatorPut(602, "Электроошейник \"PetLiner 500\"");
			*/
			...
			//translatorPut(1038, "Инкубатор автоматический \"HHD 360\" (H-360)");
			//translatorPut(1044, "Инкубатор автоматический \"HHD 7\"");
